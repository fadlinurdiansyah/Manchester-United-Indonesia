...
extension UIView {
    ...
    //MARK: Method Auto Layout + Ukuran object
...
//MARK: Method mencari tinggi Navigation Bar dan Status Bar
...
extension UINavigationBar {
    ...
    func makeTransparant(withTint tint: UIColor = .white) {
