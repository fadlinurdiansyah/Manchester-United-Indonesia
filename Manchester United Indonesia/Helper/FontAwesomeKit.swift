...
extension UIButton {
    ...
    func setFontAwesome(unicode :String, color :UIColor){
        setFontAwesome(unicode: unicode, color:UIColor.black, forState:UIControl.State.normal)
    }
    ...
    func setFontAwesome(unicode :String, color :UIColor, forState: UIControl.State){
...
extension UIBarButtonItem {
    ...
    func setFontAwesome(unicode :String, size: CGFloat, forState: UIControl.State){
        let charAsInt = Int(unicode, radix: 16)!
        let uScalar = UnicodeScalar(charAsInt)
        let strUnicode = String(UnicodeScalar(uScalar!))
        
        let attributes = [NSAttributedString.Key.font: UIFont(name: nameFont, size: size)!]
